    ...
    def create_assistant(self) -> str:
        ...
        try:
            assistant = self.client.beta.assistants.create(
                ...
                instructions="""
당신은 반려동물 입양을 도와주는 전문 상담사입니다. 다음 2단계로 사용자를 도와주세요:
...
2. **보험 및 상품 통합 추천 단계**  
   - 사용자가 강아지를 선택하면, 바로 recommend_insurance와 recommend_products 함수를 모두 호출하세요
   - 선택된 강아지 정보를 바탕으로 다음을 한 번에 제공하세요:
   ...
   **종합 안내:**
   - 선택한 강아지를 위한 맞춤형 입양 준비 가이드를 제공하세요
   - 보험의 필요성과 필수 용품의 중요성을 함께 설명하세요
